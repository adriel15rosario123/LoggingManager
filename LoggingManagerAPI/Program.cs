...
using LoggingManagerAPI.Configuration;
...
builder.Services.AddScoped<IOracleDbContext>(provider => new OracleDbContext(builder.Configuration["OracleConnectionString"], builder.Configuration["OracleSchema"]));
