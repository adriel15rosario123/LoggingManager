...
{
    public class EnrollNewSystemStrategy : IProcedureStrategy
    {
        private OracleCommand command;

        public EnrollNewSystemStrategy(OracleCommand command)
        {
               ...
               new OracleParameter()
                {
                    ...
                    Value = (inputs as CreateSystemDto)!.Username,
                    Size = 200
                },
                new OracleParameter()
                {
                    ...
                    OracleDbType = OracleDbType.NVarchar2,
                    Value = (inputs as CreateSystemDto)!.Password,
                    Size = 200
                },
                new OracleParameter()
                {
                    ...
                    OracleDbType = OracleDbType.NVarchar2,
                    Value = (inputs as CreateSystemDto)!.SystemName,
                    Size = 200
                },
